<?php 
	...
	$query = "UPDATE choco_products SET visits = visits + 1 WHERE productid = 'product9'";
	mysql_query($query);
	mysql_query("UPDATE products_1 SET VisitedNum = VisitedNum + 1 WHERE ProductID = '109'");
?>
...
<body style="background-color: #FFE1B1;">
	...
	<div class="container">
		<div class="product-box">
			<div class="row">
				<h2>Continental Almond Chocolate Bars</h2>
			</div>
			<div class="row">
				<img src="../img/product9.jpg">
			</div>
			<div class="row">
				Turkish Almonds and Roasted Pumpkin Seeds Enrobed in a Chewy, Milk Chocolate, Caramel Coating.
			</div>
		</div>
	</div>
